...
export const JOB_TYPE_LABEL: Record<string, string> = {
  ...
  "analysis.pairwise": "Pairwise similarity",
  "analysis.cluster": "Clustering",
  "analysis.outlier": "Outlier detection",
  "analysis.sampling": "Representative sampling",
  "analysis.coverage": "Dataset coverage",
  "analysis.overlap": "Dataset overlap",
  "analysis.acquisition": "Novelty acquisition",
  "analysis.compare": "Descriptor comparison",
  "analysis.feature_variance": "Feature variance",
  "analysis.feature_correlation": "Feature correlation",
  "analysis.effective_dimension": "Effective dimension",
  "analysis.property_correlation": "Property correlation",
  "analysis.local_diversity": "Local diversity",
  "analysis.kernel": "Kernel diagnostics",
  "analysis.trajectory": "Trajectory",
  "analysis.drift": "Dataset drift",
  "analysis.sensitivity": "Parameter sensitivity",
