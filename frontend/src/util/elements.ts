...
// Standard atomic weights (IUPAC 2021), amu — used for mass-density estimates.
export const ATOMIC_MASS: Record<string, number> = {
  ...
  Cl: 35.45, Ar: 39.95, K: 39.0983, Ca: 40.078, Sc: 44.955908, Ti: 47.867,
  ...
  Zr: 91.224, Nb: 92.90637, Mo: 95.95, Tc: 98, Ru: 101.07, Rh: 102.9055,
  ...
  Pm: 145, Sm: 150.36, Eu: 151.964, Gd: 157.25, Tb: 158.92535, Dy: 162.5,
  ...
  Pb: 207.2, Bi: 208.9804, Po: 209, At: 210, Rn: 222, Fr: 223, Ra: 226,
